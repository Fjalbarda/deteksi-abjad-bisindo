...
video_button = tk.Button(
    image=btn_video, borderwidth=0, highlightbackground="#4c1d95", highlightthickness=30,
...
camera_button = tk.Button(
    image=btn_camera, borderwidth=0, highlightbackground="#4c1d95", highlightthickness=30,
...
image_button = tk.Button(
    image=btn_image, command=open_image, highlightbackground="#4c1d95", highlightthickness=30)
