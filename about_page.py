...
def display_about_page():
    ...
    text_widget.insert(
        "end", "Aplikasi ini menggunakan algoritma You Only Look Once (YOLO), Bahasa Pemrograman Python 3.10.11, Tkinter dan Google Text-To-Speech untuk mengidentifikasi abjad A-Z dalam Bahasa Isyarat Indonesia.\n", "content")
    text_widget.insert("end", "\n")
    text_widget.insert("end", "Algoritma YOLO adalah sistem deteksi objek waktu nyata yang dapat mendeteksi dan mengklasifikasikan objek dalam gambar atau aliran video. Dalam aplikasi ini, algoritma ini dilatih untuk mengenali isyarat tangan yang sesuai dengan huruf A-Z dalam Bahasa Isyarat Indonesia.\n", "content")
    text_widget.insert("end", "\n")
